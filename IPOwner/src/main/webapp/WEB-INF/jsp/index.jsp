...
<head>
	...
	<!-- start: CORE CSS -->
	<link rel="stylesheet"
	href="${pageContext.request.contextPath}/assets/plugins/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css">
	...
	<!-- end: CSS REQUIRED FOR THIS SUBVIEW CONTENTS-->
	<!-- end: CORE CSS -->
	<link rel="shortcut icon" type="image/ico" href="${pageContext.request.contextPath}/assets/images/favicon.ico" />
</head>
<!-- end: HEAD -->
<!-- start: BODY -->
<body>
...
<!-- start: MAIN JAVASCRIPTS -->
		...
		<script src="${pageContext.request.contextPath}/assets/plugins/velocity/jquery.velocity.min.js"></script>
		<!-- end: MAIN JAVASCRIPTS -->
		<!-- start: JAVASCRIPTS REQUIRED FOR SUBVIEW CONTENTS -->
		<script
		src="${pageContext.request.contextPath}/assets/plugins/owl-carousel/owl-carousel/owl.carousel.js"></script>
		<script src="${pageContext.request.contextPath}/assets/plugins/jquery-mockjax/jquery.mockjax.js"></script>
		...
		<script src="${pageContext.request.contextPath}/assets/plugins/truncate/jquery.truncate.js"></script>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/table-data.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/assets/scripts/script_01.js"></script>
		<!-- end: JAVASCRIPTS REQUIRED FOR SUBVIEW CONTENTS -->
		<!-- start: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
		<!-- end: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
		<script
		src="${pageContext.request.contextPath}/assets/plugins/jquery-inputlimiter/jquery.inputlimiter.1.3.1.min.js"></script>
		...
		<script
		src="${pageContext.request.contextPath}/assets/plugins/jquery.maskedinput/src/jquery.maskedinput.js"></script>
		<script
		src="${pageContext.request.contextPath}/assets/plugins/jquery-inputlimiter/jquery.inputlimiter.1.3.1.min.js"></script>
		...
		<script
		src="${pageContext.request.contextPath}/assets/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js"></script>
		<script
		...
		<script
		src="${pageContext.request.contextPath}/assets/plugins/bootstrap-colorpalette/js/bootstrap-colorpalette.js"></script>
		<script
		src="${pageContext.request.contextPath}/assets/plugins/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js"></script>
		...
		<script src="${pageContext.request.contextPath}/assets/js/ui-notifications.js"></script>
		<script src="${pageContext.request.contextPath}/assets/plugins/toastr/toastr.js"></script>
		...
		<script src="${pageContext.request.contextPath}/assets/plugins/owl-carousel/owl-carousel/owl.carousel.js"></script>
		<script src="${pageContext.request.contextPath}/assets/plugins/jquery-mockjax/jquery.mockjax.js"></script>
		<script src="${pageContext.request.contextPath}/assets/plugins/toastr/toastr.js"></script>
		<script src="${pageContext.request.contextPath}/assets/plugins/bootstrap-modal/js/bootstrap-modal.js"></script>
		<script src="${pageContext.request.contextPath}/assets/plugins/bootstrap-modal/js/bootstrap-modalmanager.js"></script>
		<script src="${pageContext.request.contextPath}/assets/plugins/fullcalendar/fullcalendar/fullcalendar.min.js"></script>
		...
		<script>
			jQuery(document).ready(function() {
				...
				var notif = "${NewServerNotification}"+"";
				if(notif !=  "")
				NewServersnotification(notif);
			...
			function NewServersnotification(message){
				var shortCutFunction = "info";
				toastr.options = {
					closeButton:true,
					debug: true,
